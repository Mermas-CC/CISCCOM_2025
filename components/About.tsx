...
export default function About() {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <h2 className="text-4xl md:text-5xl font-bold mb-6 text-center bg-gradient-to-r from-blue-400 to-cyan-300 bg-clip-text text-transparent">
          Acerca del Evento
        </h2>
      
        <div className="bg-gradient-to-br from-blue-900/20 to-cyan-900/10 backdrop-blur-sm border border-cyan-400/20 rounded-2xl p-8 md:p-10 shadow-lg shadow-cyan-500/10">
  ...
  <strong className="text-cyan-300"> desarrollo de software</strong>.
        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 mt-10 px-2">
  {features.map((feature, index) => (
    <motion.div
      ...
      className="group flex flex-col justify-between bg-gradient-to-br from-blue-900/30 to-cyan-900/20 backdrop-blur-md border border-cyan-400/20 rounded-2xl p-6 md:p-8 text-center hover:border-cyan-400/50 hover:shadow-lg hover:shadow-cyan-500/10 transition-all duration-300 w-full h-full min-h-[320px]"
    >
      <div>
        <div className="mb-4 flex justify-center transform group-hover:scale-110 transition-transform duration-300">
          <feature.icon className="w-12 h-12 md:w-14 md:h-14 text-cyan-400 group-hover:text-cyan-300 transition-colors" strokeWidth={1.5} />
        </div>
